...
export const FaqSection = () => {
    ...
    return (
        <div className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            ...
            <SectionTitle text1="FAQ's" text2="Frequently asked questions" text3="Here are some of the questions oftenly asked by some of our clients and with detailed answers of each of them ,if your question is not listed down feel free
            to reach out to us we shall provide the answer in the shortest time available." />
            <div className="mt-8">
