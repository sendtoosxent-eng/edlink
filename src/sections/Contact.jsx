        ...
        <>
            ...
            <section className="flex items-center justify-center py-12 px-4">
                <div className="grid md:grid-cols-2 md:gap-10 lg:gap-20 max-w-7xl w-full items-center">
                    ...
                    <div className="p-5">
                        <h1 className="text-3xl font-semibold text-white-900 text-center md:text-start mb-3 tracking-tight">
                            Get in touch
                        </h1>
                        <p className="text-sm/6 text-white-600 text-center md:text-start mx-auto md:mx-0 mb-8 leading-relaxed max-w-[400px]">
                        ...
                        <form>
                            <div className="grid grid-cols-2 gap-4 mb-5">
                                <div>
                                    ...
                                    <input type="text" placeholder="Osxent" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors" />
                                </div>
                                <div>
                                    <label className="block text-sm text-gray-500 mb-2">Last name</label>
                                    <input type="text" placeholder="Musisi" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors" />  
                                </div>
                            </div>

                            <div className="mb-5">
                                <label className="block text-sm text-gray-500 mb-2">Email id</label>
                                <input type="email" placeholder="osxent@spotnet.com" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors"/>
                            </div>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:border-indigo-500 transition-colors">
                                    ...
                                    <input type="tel" placeholder="+256 743946261" className="flex-1 px-3 py-3 text-sm outline-none" />
                                </div>
                            </div>
